...
const API_URL_PLANS = 'https://localhost:49851/api/ProductionPlans';
const API_URL_PLAN_ITEMS = 'https://localhost:49851/api/ProductionPlanItems'; // Giả định có một Controller riêng cho ProductionPlanItems
