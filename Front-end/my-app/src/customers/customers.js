...
export const Customers = () => {
  ...
  return (
    <div className="p-4 sm:p-6 bg-gray-50/50 min-h-screen">
      ...
      <div className="flex flex-col lg:flex-row justify-between items-center mb-6 gap-4">
        ...
        <div className="grid grid-cols-2 gap-2 w-full lg:w-auto lg:flex lg:flex-wrap">
          <button
            ...
            className="order-1 lg:order-2 w-full lg:w-auto justify-center bg-orange-500 hover:bg-orange-600 text-white font-bold py-2 px-3 rounded whitespace-nowrap transition-all active:scale-95 flex items-center gap-2 shadow-sm text-sm"
          >
            <FileUp size={16} />
          ...
          <button
            ...
            className={`order-3 lg:order-1 w-full lg:w-auto justify-center text-white font-bold py-2 px-3 rounded whitespace-nowrap transition-all flex items-center gap-2 text-sm ${selectedCustomerIds.length > 0 ? 'bg-red-700 hover:bg-red-700 shadow-md active:scale-95' : 'bg-red-700 hover:bg-red-700'}`}
          >
            <Trash2 size={16} />
      ...
      {loading ? (
        <p className="text-gray-600 p-4">Đang tải dữ liệu khách hàng...</p>
      ) : (
