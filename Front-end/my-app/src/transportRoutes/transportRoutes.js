  ...
  return (
    <div className="p-4 sm:p-6 bg-gray-50/50 min-h-screen">
      <div className="mb-6 sm:mb-8">
        ...
        <p className="text-gray-500 text-xs sm:text-sm mb-6">Quản lý các chuyến hàng đang vận hành</p>
        ...
        <div className="flex flex-col lg:flex-row justify-between items-stretch lg:items-center gap-4">
          ...
          <button
            ...
            className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2.5 px-6 rounded-xl flex items-center justify-center gap-2 transition-all shadow-lg shadow-blue-100 active:scale-95 text-sm"
          >
            + Tạo chuyến hàng
          </button>
        </div>
